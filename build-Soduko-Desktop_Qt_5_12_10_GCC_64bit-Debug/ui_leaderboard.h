...
""));
        ...
        pushButton_3->setMaximumSize(QSize(150, 80));
        pushButton_3->setFont(font2);
        pushButton_3->setStyleSheet(QString::fromUtf8("background-color: qlineargradient(spread:pad, x1:0.736, y1:0.585, x2:1, y2:0.04, stop:0 rgba(38, 112, 246, 255), stop:1 rgba(238, 238, 236, 255));"));
    ...
    void retranslateUi(QWidget *leaderBoard)
    {
        ...
        pushButton_3->setText(QApplication::translate("leaderBoard", "Exit", nullptr));
